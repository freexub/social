...
class QuestionsController extends Controller
{
    ...
    public function actionDeleteLink(){
        if ($this->request->isPost) {
            $modelLink = QuestionsTalent::find()->where(['questions_id'=>$_POST["QuestionsTalent"]['questions_id'], 'talent_id'=>$_POST["QuestionsTalent"]['talent_id']])->one();
            $modelLink->delete();
            return $this->redirect(\Yii::$app->request->referrer);
        }
    }
